...
from .const import DOMAIN, ICONS, SWITCH_DEFINITIONS, TOILET_COMMANDS
...
class SmartToiletSwitch(SmartToiletEntity, SwitchEntity):
    ...
    def __init__(
        ...
        self._on_cmd = TOILET_COMMANDS[switch_def.on_command]
        self._off_cmd = TOILET_COMMANDS[switch_def.off_command] if switch_def.off_command else None
